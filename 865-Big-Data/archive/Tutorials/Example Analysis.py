...
# MAGIC %md
# MAGIC 
# MAGIC # Amazon Review Analysis
# MAGIC 
# MAGIC Data source: https://nijianmo.github.io/amazon/index.html
# MAGIC 
# MAGIC Useful resources: 
# MAGIC - PySpark cheat sheet: http://web.utk.edu/~wfeng1/doc/cheatSheet_pyspark.pdf
# MAGIC - MLlib document: https://spark.apache.org/docs/latest/ml-guide.html
# MAGIC - SparkR document: https://spark.apache.org/docs/latest/sparkr.html
# MAGIC - SparkR tutorial: https://rpubs.com/wendyu/sparkr
